...
function Body({ definition, label: name, id: ensemblId }) {
  ...
  return (
    <SectionItem
      ...
      renderBody={({ target: { similarW2VEntities } }) => {
        // process the data
        ...
        return (
          <>
            ...
            <div className={classes.root}>
              ...
              <Chip label={name} title={`ID: ${ensemblId}`} color="primary" />
