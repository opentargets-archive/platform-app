...
const columns = [
  ...
  // { id: 'Gene_Symbol', label: 'Gene_Symbol', sortable:true },
  { id: 'Alt_ID', label: 'Alt ID', sortable:true },
  { id: 'Total_alterations', label: 'Total alterations', sortable:true },
  { id: 'Patients_in_dataset', label: 'Patients in dataset', sortable:true },
  ...
  { id: 'Total_relapse_tumors_mutated_Over_Relapse_tumors_in_dataset', label: 'Total_relapse tumors mutated Over Relapse tumors in dataset', sortable:true },
  ...
  // { id: 'Gene_Ensembl_ID', label: 'Gene_Ensembl_ID', sortable:true },
