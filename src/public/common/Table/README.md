...
| `width`        | `string`   |         | A value in `px` or `%` for the column's width. **Note**: if the prop `fixed` is not present in the table, this value will not be used literally, the browser will try to adapt without breaking cell content.                                                                                                                                                                                                                                                                                                        |
| `minWidth`     | `string`   |         | A value in `px` for the column's minimum width.                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
